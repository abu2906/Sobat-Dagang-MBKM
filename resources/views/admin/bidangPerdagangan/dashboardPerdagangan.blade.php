            ...
            <div class="flex-1 overflow-x-auto border border-gray-200 rounded-xl">
                <table class="min-w-full text-sm text-left">
                    ...
                    <tbody>
                        ...
                        <td class="px-4 py-2">{{ $surat->nomor }}</td>
                        <td class="px-4 py-2">{{ $surat->pengirim }}</td>
                        <td class="px-4 py-2">{{ \Carbon\Carbon::parse($surat->tanggal_masuk)->format('d M Y') }}</td>
                        <td class="px-4 py-2">
                            <button class="px-4 py-1 text-xs text-white bg-blue-600 rounded-full hover:bg-blue-700">BACA</button>
                        </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="5" class="py-4 text-center text-gray-500">Tidak ada surat masuk</td>
                        </tr>
                        @endforelse --}}
                    </tbody>
                </table>
