...
<div class="p-6 bg-gray-100 min-h-screen">
    ...
    <div id="popupDetailAlat" class="fixed inset-0 z-50 hidden justify-center items-center bg-black bg-opacity-50">
        <div class="bg-white p-4 sm:p-6 rounded-xl w-[90%] sm:w-[85%] md:w-[70%] lg:w-[50%] max-w-[600px] relative shadow-xl mx-auto ml-[calc(16.666667%+1rem)] sm:ml-[calc(16.666667%+2rem)] mr-[calc(1%+1rem)] sm:mr-[calc(1%+2rem)]">
            ...
            <h2 class="text-center font-bold text-base sm:text-lg mb-4">
                Detail Alat Ukur - 
    ...
    <div id="modalTambahAlat" class="fixed inset-0 z-40 hidden bg-black bg-opacity-30 flex items-center justify-center overflow-y-auto">
        ...
        <div class="relative bg-white w-[90%] sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%] rounded-lg shadow-lg p-4 sm:p-6 my-4 sm:my-8 max-h-[90vh] overflow-y-auto mx-auto ml-[calc(16.666667%+1rem)] sm:ml-[calc(16.666667%+2rem)] mr-[calc(1%+1rem)] sm:mr-[calc(1%+2rem)]">
            <div class="flex justify-between items-center border-b pb-3 mb-4">
                <h2 class="text-base sm:text-lg font-semibold">Tambah UTTP</h2>
            ...
            <input type="hidden" name="_method" id="formMethod" value="POST">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                    <div>
                        <label class="block text-xs sm:text-sm font-medium mb-1">Tanggal Mulai <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs sm:text-sm font-medium mb-1">Tanggal Selesai <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs sm:text-sm font-medium mb-1">Nama Usaha <span class="text-red-500">*</span></label>
                        <input type="text" name="nama_usaha" class="w-full border rounded px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm" required>
                    </div>
                    <div>
                        <label class="block text-xs sm:text-sm font-medium mb-1">Jenis Alat <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs sm:text-sm font-medium mb-1">Cap Tanda Tera <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs sm:text-sm font-medium mb-1">No Surat Perintah Tugas</label>
                        <input type="text" name="spt_keperluan" class="w-full border rounded px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm">
                    </div>
                    <div>
                        <label class="block text-xs sm:text-sm font-medium mb-1">Keterangan <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs sm:text-sm font-medium mb-1">Sertifikat (PDF)</label>
                    ...
                    <div class="flex items-center space-x-2 mt-2">
                        ...
                        <label for="terapan" class="text-xs sm:text-sm font-medium">Cerapan</label>
                    </div>
                </div>
...
<script>
    ...
    function loadDetailAlat(id) {
        ...
        .then(data => {
            ...
            body.innerHTML = `
                <tr class="hover:bg-gray-50"><td class="py-2 px-2 sm:px-4 font-semibold">Nama Usaha</td><td class="py-2 px-2 sm:px-4">: ${data.nama_usaha ?? '-'}</td></tr>
                <tr class="hover:bg-gray-50"><td class="py-2 px-2 sm:px-4 font-semibold">Jenis Alat</td><td class="py-2 px-2 sm:px-4">: ${data.jenis_alat ?? '-'}</td></tr>
                <tr class="hover:bg-gray-50"><td class="py-2 px-2 sm:px-4 font-semibold">Merk / Tipe</td><td class="py-2 px-2 sm:px-4">: ${data.merk_type ?? '-'}</td></tr>
                <tr class="hover:bg-gray-50"><td class="py-2 px-2 sm:px-4 font-semibold">Kapasitas</td><td class="py-2 px-2 sm:px-4">: ${data.nama_alat ?? '-'}</td></tr>
                <tr class="hover:bg-gray-50"><td class="py-2 px-2 sm:px-4 font-semibold">Nomor Seri</td><td class="py-2 px-2 sm:px-4">: ${data.nomor_seri ?? '-'}</td></tr>
                <tr class="hover:bg-gray-50"><td class="py-2 px-2 sm:px-4 font-semibold">Alat Penguji</td><td class="py-2 px-2 sm:px-4">: ${data.alat_penguji ?? '-'}</td></tr>
                <tr class="hover:bg-gray-50"><td class="py-2 px-2 sm:px-4 font-semibold">Cap Tanda Tera</td><td class="py-2 px-2 sm:px-4">: ${data.ctt ?? '-'}</td></tr>
                <tr class="hover:bg-gray-50"><td class="py-2 px-2 sm:px-4 font-semibold">No Surat Perintah Tugas</td><td class="py-2 px-2 sm:px-4">: ${data.spt_keperluan ?? '-'}</td></tr>
                <tr class="hover:bg-gray-50"><td class="py-2 px-2 sm:px-4 font-semibold">Tanggal Mulai</td><td class="py-2 px-2 sm:px-4">: ${data.tanggal_penginputan ?? '-'}</td></tr>
                <tr class="hover:bg-gray-50"><td class="py-2 px-2 sm:px-4 font-semibold">Tanggal Selesai</td><td class="py-2 px-2 sm:px-4">: ${data.tanggal_selesai ?? '-'}</td></tr>
                <tr class="hover:bg-gray-50"><td class="py-2 px-2 sm:px-4 font-semibold">Keterangan</td><td class="py-2 px-2 sm:px-4">: ${data.keterangan ?? '-'}</td></tr>
                <tr class="hover:bg-gray-50"><td class="py-2 px-2 sm:px-4 font-semibold">Sertifikat</td><td class="py-2 px-2 sm:px-4">: ${data.sertifikat_path ? `<a href="/storage/${data.sertifikat_path}" target="_blank" class="text-blue-600 hover:text-blue-800">Lihat Sertifikat</a>` : '<span class="text-gray-500">Belum di upload oleh admin</span>'}</td></tr>
            `;
