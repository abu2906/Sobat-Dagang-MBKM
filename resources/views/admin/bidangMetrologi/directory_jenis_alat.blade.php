    ...
    <table class="min-w-full text-sm text-left text-gray-700 bg-white border border-gray-200">
            <thead class="bg-[#1e3a8a] text-white">
                <tr>
                    ...
                    <th scope="col" class="text-center px-5 py-3 font-medium border-b border-blue-100">Nama Jenis Alat</th>
                    <th scope="col" class="text-center px-5 py-3 font-medium border-b border-blue-100">Kategori Alat</th>
                    <th scope="col" class="text-center px-5 py-3 font-medium border-b border-blue-100">Kode</th>
            ...
            <tbody>
                <tr class="hover:bg-blue-50 transition">
                    ...
                    <td class="px-5 text-center py-3 border-b">Massa</td>
                    <td class="px-5 text-center py-3 border-b">MTD-001</td>                 
