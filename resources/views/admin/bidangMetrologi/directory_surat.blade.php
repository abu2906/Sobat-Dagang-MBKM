...
<div class="p-4 sm:p-6 bg-gray-100 min-h-screen">
	<div class="relative h-[150px] w-full bg-cover bg-[center_87%]" style="background-image: url('/assets/img/background/user_metrologi.png');">
		<div class="w-full px-4 sm:px-8 relative lg:absolute lg:bottom-[-30px]">
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-2">
				...
				<a href="#" class="bg-[#0c3252] rounded-2xl shadow-md hover:shadow-lg transition p-4 flex items-center space-x-3">
					<img src="{{ asset('assets/img/icon/Verif.png') }}" alt="Disetujui" class="w-10 h-10 sm:w-12 sm:h-12 flex-shrink-0">
					<div class="min-w-0 flex-1">
				...
				<table class="min-w-full text-sm text-left text-gray-700 bg-white border border-gray-200">
					<thead class="bg-[#0c3252] text-white">
						<tr>
							...
							<th scope="col" class="px-3 sm:px-5 py-3 font-medium border-b border-blue-100 text-center">Nama Pemohon</th>
							<th scope="col" class="px-3 sm:px-5 py-3 font-medium border-b border-blue-100 text-center hidden md:table-cell">Jenis Permohonan</th>
							<th scope="col" class="px-3 sm:px-5 py-3 font-medium border-b border-blue-100 text-center">Status</th>
					...
					<tbody>
						...
						<tr class="hover:bg-blue-50 transition">
							<td class="px-3 sm:px-5 py-3 border-b text-center">{{ $index + 1 }}</td>
							<td class="px-3 sm:px-5 py-3 border-b text-center">{{ $surat->id_surat }}</td>
							<td class="px-3 sm:px-5 py-3 border-b text-center">
								{{ \Carbon\Carbon::parse($surat->created_at)->format('d-m-Y') }}
							</td>
							<td class="px-3 sm:px-5 py-3 border-b text-center hidden sm:table-cell">{{ $surat->user->id_user ?? '-' }}</td>
							<td class="px-3 sm:px-5 py-3 border-b text-center">{{ $surat->user->nama ?? '-' }}</td>
							<td class="px-3 sm:px-5 py-3 border-b text-center hidden md:table-cell">
