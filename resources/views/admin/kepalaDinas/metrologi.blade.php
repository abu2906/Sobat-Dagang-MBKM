...
<div id="previewModal" class="fixed inset-0 z-50 hidden bg-black bg-opacity-50">
            ...
            <table class="min-w-full text-sm text-left text-gray-700 bg-white border border-gray-200">
                ...
                <tbody>
                    ...
                    <tr class="transition hover:bg-blue-50">
                        ...
                        <td class="px-5 py-3 text-center border-b">{{ $surat->id_surat_balasan }}</td>
                        <td class="px-3 py-3 text-center border-b sm:px-5">
							{{ \Carbon\Carbon::parse($surat->created_at)->format('d-m-Y') }}
						</td>
                        <td class="px-5 py-3 text-center border-b">{{ $surat->suratMetrologi->user->nama ?? '-' }}</td>
                        <td class="hidden px-3 py-3 text-center border-b sm:px-5 md:table-cell">
							{{ $surat->suratMetrologi->jenis_surat ? ucwords(str_replace('_', ' ', $surat->suratMetrologi->jenis_surat)) : '-' }}
						</td>
                        ...
                        <td class="px-5 py-3 text-center border-b">
                            <div class="flex flex-wrap items-center justify-center gap-2">
                                ...
                                class="inline-flex items-center justify-center text-blue-700 transition duration-200 hover:scale-105" 
                                title="Lihat Surat">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
