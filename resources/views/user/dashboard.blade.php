...
<div class="flex justify-center mt-7 mb-10 space-x-20">
    <!-- Kartu 1 -->
    <div class="w-[300px] bg-white p-8 rounded-lg border border-gray-300 shadow-[0_8px_20px_rgba(8,52,88,0.2)] text-center">
        ...
        <h3 class="text-xl font-bold mb-2">IZIN USAHA TOKO</h3>
        <p class="text-black text-base">Fitur untuk pelaku usaha melaporkan kegiatan usahanya secara rutin</p>
    </div>
