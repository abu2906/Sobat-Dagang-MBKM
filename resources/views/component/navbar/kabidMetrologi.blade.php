    ...
    <div :class="open ? 'w-64' : 'w-20'"
        ...
        <div class="p-4 space-y-6">
            ...
            <ul class="space-y-2 text-sm">
                @php
                $menuItems = [
                ['href' => route('dashboard-kabid-metrologi'), 'icon' => 'dashboard.png', 'label' => 'Dashboard'],
                ['href' => route('informasi-uttp'), 'icon' => 'folder.png', 'label' => 'Lihat Informasi Uttp'],
                ['href' => route('administrasi-kabid-metrologi'), 'icon' => 'persuratan.png', 'label' => 'Persuratan'],
                ];
                @endphp
        ...
        <div class="p-4 space-y-4">
            <div class="flex items-center">
                ...
                <div class="ml-3" x-show="open">
                    <p class="text-sm font-semibold">Kepala Bidang Metrologi</p>
                </div>
            </div>
