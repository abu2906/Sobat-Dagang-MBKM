    ...
    <div :class="open ? 'w-64' : 'w-20'"
        ...
        <div class="p-4 space-y-6">
            ...
            <ul class="space-y-2 text-sm">
                @php
                $menuItems = [
                ['href' => route('kabid.perdagangan'), 'icon' => 'dashboard.png', 'label' => 'Dashboard'],
                ['href' => route('analisis.pasar'), 'icon' => 'trending_up.png', 'label' => 'Analisis Pasar'],
                ['href' => route('distribusi.pupuk'), 'icon' => 'tag.png', 'label' => 'Distribusi Pupuk'],
                ];
                @endphp
        ...
        <div class="p-4 space-y-4">
            <div class="flex items-center">
                ...
                <div class="ml-3" x-show="open">
                    ...
                    <p class="text-sm font-semibold">Kabid Perdagangan</p>
