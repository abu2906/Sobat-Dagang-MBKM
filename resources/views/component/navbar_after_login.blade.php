<nav class="bg-blue-900 text-white p-4 flex items-center justify-between">
    <div class="flex items-center space-x-2">
        <img src="/assets/img/Logo_disdag.png" alt="Logo" class="h-12">
    </div>
    ...
    <div class="flex items-center space-x-4">
        ...
        <button class="text-white px-4 py-1 rounded-md text-sm font-semibold">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-white hover:text-gray-600 cursor-pointer"
                fill="none" viewBox="0 0 24 24" stroke="currentColor">
