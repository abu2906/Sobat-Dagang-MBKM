...
<div class="relative w-full h-64">
    <img src="{{ asset('img/bgpelaporan.png') }}" alt="Port Background" class="object-cover w-full h-full">
    <div class="absolute bottom-0 transform -translate-x-1/2 translate-y-1/2 left-1/2">
        <p class="px-6 py-3 font-bold text-black bg-white shadow-md text-md font-istok rounded-3xl shadow-black/40">
            ...
            <tbody>
                <tr class="border-b-2 border-[#889EAF] hover:bg-gray-50">
                    ...
                    <td class="flex items-center justify-center px-6 py-4 text-sm text-gray-700">
                        <a href="">
                            <img src="{{ asset('img/edit-icon.png') }}" alt="Edit" class="w-5 h-5">
                        </a>
                    </td>
                </tr>
                <tr class="border-b-2 border-[#889EAF] hover:bg-gray-50">
