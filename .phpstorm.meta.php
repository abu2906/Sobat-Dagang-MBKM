...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\Sobat-Dagang-MBKM\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\Sobat-Dagang-MBKM\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'Home','about','login','login.submit',
'register','register.submit','forgot.password','change.password','logout',
'user.dashboard','profile','profile.update','profile.update','berita.utama',
'kelola.berita','berita.edit','halal','pelaporan','review.pengajuan','dashboard.perdagangan','dashboard-perdagangan.form-tambah-barang','dashboard-perdagangan.tambah-barang','updateHarga.store','lihat.laporan','tambah.barang-distribusi','directory-book',
'data-ikm','sertifikasi-ikm','directory-metrologi','persuratan','administrasi-metrologi',
'dashboard-admin-metrologi','alat-ukur-metrologi','managemen-uttp-metrologi','persuratan-metrologi',
'form.permohonan','riwayat.surat','storage.local',);
        registerArgumentsSet('views', 
'admin.adminSuper.kelola_berita','admin.adminSuper.lihatLaporan','admin.adminSuper.reviewPengajuanDistributor','admin.adminSuper.tambahBarangDistribusi','admin.bidangMetrologi.dashboard',
'admin.bidangMetrologi.directory_alat_ukur_sah','admin.bidangMetrologi.directory_jenis_alat','admin.bidangMetrologi.directory_surat','admin.bidangPerdagangan.dashboardPerdagangan','admin.bidangPerdagangan.tambahBarang',
'admin.bidangPerdagangan.updateHarga','component.footer','component.navbar.adminPerdagangan','component.navbar.adminPerindustrian','component.navbar.admin_metrologi',
'component.navbar.guest','component.navbar.user','component.popup_surat','component.profile','layouts.admin',
'layouts.admin_metrologi','layouts.home','layouts.menuAdminPerdagangan','layouts.user','pages.aboutUs',
'pages.auth.changepass','pages.auth.forgotpass','pages.auth.login','pages.auth.register','pages.auth.resetpass',
'pages.auth.verification','pages.halamanBerita','pages.home','pages.pelaporan_penyaluran','user.bidangMetrologi.administrasi',
'user.bidangMetrologi.directory','user.bidangPerdagangan.pelaporan','user.bidangPerdagangan.pelaporan_penyaluran','user.bidangPerdagangan.verifikasiPengajuan','user.dashboard',
'user.form_permohonan','user.halal','user.riwayat_surat','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
